"""
Tests for Caching Service - Component 005
...
from .caching_service_005 import CachingService, CachingServiceConfig, create_caching_service
...
class TestCachingService:
    ...
    def config(self):
        ...
        return CachingServiceConfig(
            component_id=f"test_caching_service_005",
            enabled=True,
            max_workers=2,
            timeout=10.0,
            retry_attempts=2
    ...
    def test_component_initialization(self, component):
        ...
        assert component.config.component_id == f"test_caching_service_005"
    ...
    def test_factory_function(self):
        ...
        component = create_caching_service("factory_test_005")
