"""
Tests for Optimization Service - Component 001
...
from .optimization_service_001 import OptimizationService, OptimizationServiceConfig, create_optimization_service
...
class TestOptimizationService:
    ...
    def config(self):
        ...
        return OptimizationServiceConfig(
            component_id=f"test_optimization_service_001",
            enabled=True,
            max_workers=2,
            timeout=10.0,
            retry_attempts=2
    ...
    def test_component_initialization(self, component):
        ...
        assert component.config.component_id == f"test_optimization_service_001"
    ...
    def test_factory_function(self):
        ...
        component = create_optimization_service("factory_test_001")
