"""
Tests for Network Service - Component 008
...
from .network_service_008 import NetworkService, NetworkServiceConfig, create_network_service
...
class TestNetworkService:
    ...
    def config(self):
        ...
        return NetworkServiceConfig(
            component_id=f"test_network_service_008",
            enabled=True,
            max_workers=2,
            timeout=10.0,
            retry_attempts=2
    ...
    def test_component_initialization(self, component):
        ...
        assert component.config.component_id == f"test_network_service_008"
    ...
    def test_factory_function(self):
        ...
        component = create_network_service("factory_test_008")
