"""
Tests for Monitoring Service - Component 007
...
from .monitoring_service_007 import MonitoringService, MonitoringServiceConfig, create_monitoring_service
...
class TestMonitoringService:
    ...
    def config(self):
        ...
        return MonitoringServiceConfig(
            component_id=f"test_monitoring_service_007",
            enabled=True,
            max_workers=2,
            timeout=10.0,
            retry_attempts=2
    ...
    def test_component_initialization(self, component):
        ...
        assert component.config.component_id == f"test_monitoring_service_007"
    ...
    def test_factory_function(self):
        ...
        component = create_monitoring_service("factory_test_007")
