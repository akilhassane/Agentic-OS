"""
Tests for Security Service - Component 012
...
from .security_service_012 import SecurityService, SecurityServiceConfig, create_security_service
...
class TestSecurityService:
    ...
    def config(self):
        ...
        return SecurityServiceConfig(
            component_id=f"test_security_service_012",
            enabled=True,
            max_workers=2,
            timeout=10.0,
            retry_attempts=2
    ...
    def test_component_initialization(self, component):
        ...
        assert component.config.component_id == f"test_security_service_012"
    ...
    def test_factory_function(self):
        ...
        component = create_security_service("factory_test_012")
